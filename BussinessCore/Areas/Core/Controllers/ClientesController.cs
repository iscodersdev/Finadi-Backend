...
namespace FINADICore.Areas.Core.Controllers
{
    ...
    public class ClientesController : FINADICoreController
    {
        private readonly UserService<Usuario> _userService;
        public ClientesController(FINADIContext context, UserService<Usuario> userService) : base(context)
        {
        ...
        public ActionResult Index()
        {
            ...
            //{
            //    int codigo = 0;
            //    FINADICore.FINADI.ActualizaPersonaCGE20(empresa, cliente, codigo.ToString(), _context);
            //}
            return View();
        }
