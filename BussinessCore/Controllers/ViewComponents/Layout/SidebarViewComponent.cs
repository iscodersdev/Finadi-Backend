...
namespace FINADICore.Controllers.ViewComponents.Layout
{
    public class SidebarViewComponent : ViewComponent
    {
        ...
        public SidebarViewComponent(FINADIContext context)
        {
        ...
        {   
            ...
            if (userIsAdmin == true)
            {
                ...
                {
                    MenuHelpers.AddModule("Prestamos por App FINADI", "/Core/PrestamosApp/"),
            ...
            else
            {
                ...
                if (HttpContext.UserHasRoute("/Core/PrestamosApp/Index"))
                    reportes.TreeChild.Add(MenuHelpers.AddModule("Prestamos por App FINADI", "/Core/PrestamosApp/"));
